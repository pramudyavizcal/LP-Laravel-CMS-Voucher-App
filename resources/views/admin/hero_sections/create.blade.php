...
@section('header', 'Create Hero Section')
        ...
        <form action="{{ route('admin.hero-sections.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6 flex items-center">
                <input type="checkbox" name="active" id="active"
                    class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" value="1" {{ old('active') ? 'checked' : '' }}>
                <label for="active" class="ml-2 block text-gray-700">Active (Set as main Banner)</label>
            </div>
            ...
            <div class="flex justify-end">
                ...
                <button type="submit"
                    class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 shadow-md transition">Save Hero
                    Section</button>
            </div>
        </form>
    </div>
